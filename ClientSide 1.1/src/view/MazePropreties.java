...
public class MazePropreties extends PropretiesWindow{
	
	private Presenter presenter;

	public MazePropreties(Presenter presenter,Display display, int width, int height,
			String title) {
	...
	void initWidgets() {
		...
		btnSearch.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent arg0) {	
				...
				UIView  m = new MazeGameWindow(presenter,null,400,400,"Maze Game", algoritemName);
				m.run();
